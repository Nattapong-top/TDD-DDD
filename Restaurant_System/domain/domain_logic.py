...
class Table(DomainValueObject):
    ...
    def _validate_not_occupied(self):
        if self.table_status == TableStatus.AVAILABLE:
            raise TableNotOccupiedError('โต๊นี้ว่างอยู่แล้วครับ')
